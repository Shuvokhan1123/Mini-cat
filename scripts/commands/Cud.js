...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("ST Shuvo BOSSআপনি কাকে চুদতে চান এমন 1 জনকে @ম্যানশন করন", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("SK SHAKIL(TOM)BOOS এর ইন্টেক চুদা খা🥵 ");
setTimeout(() => {a({body: "খাংকির পোলা তুই আমার বস🥵ST Shuvo এর চুদা🥵 shuvo 🥵🥵তর আব্বু লাগে Shuvo 🥵🥵তর মার ভুদা কামরা ই কাম্রাই খায় 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি বোন রে আমার বস টম চুদবো 😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু পম পম খাংকির পো  Shuvo 🥵🥵Boss🥵তর কচি বোন্রে চুদে🥵তর কচু বোনের দুদ খায়🥵🥵🐰" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি ভুদায় ভুদায় কামর দিমু  💔!" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "খাংকি মাগির পোলা কথা ক কম কম তর আম্মু রে চুদে বানামু আইটেম বোম Shuvo 🥵🥵Boss🥵তর মার ভুদা চুইদা ফাটায় বান্দির পুলা🥵🥵 " + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "depression থেকেও তর মাইরে চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 15000);
setTimeout(() => {a({body: "তর আম্মু রে আচার এর লোভ দেখি চুদি মাগির পোলা🤬Shuvo 🥵🥵Boss🥵রে গালি দিলে তুর মারে চুইদা মারমু🥵🥵" + " " + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "বান্দির পোলা তর কচি বোনের ভুদা ফাক কর থুতু দিয়ে ভুদায় দন ডুকামু 🤟Shuvo 🥵🥵Boss🥵তর মাইরে আস্তে আস্তে চুদে🥵" + " " + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "বান্দি মাগির পোলা তর আম্মু রে চুদি তর দুলা ভাই এর কান্দে ফেলে  🤝" + " " + name, mentions: arraytag})},23000);
setTimeout(() => {a({body: "উফফফ খাদ্দামা মাগির পোলা তর আম্মুর কালা ভুদায় আমার মাল আউট তর কচি বোন রে উপ্তা করে এবার চুদবো  💉Shuvo 🥵🥵Boss🥵তর আব্বু লাগে আব্বু ক পুত🥵🥵" + " " + name, mentions: arraytag})}, 25000);
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি  ইমরান তর বাপ মাগির ছেলে 😘 Shuvo 🥵🥵Boss🥵তোর বোন রে আস্তে আস্তে চুদবো মাগির পুলা🥵🥵" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "বাতিজা শুন তর আম্মু রে চুদলে রাগ করবি না তো আচ্ছা জা রাগ করিস না তর আম্মুর কালা ভুদায় আর চুদলাম না তো বোন এর জামা টা খুলে দে  ✋Shuvo 🥵🥵Boss🥵আমার বস তর বনরে বেসিনা ২০ মিনিট চুদবে🥵🥵🥵" + " " + name, mentions: arraytag})},31000);
